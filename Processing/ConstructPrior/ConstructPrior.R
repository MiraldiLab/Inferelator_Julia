...
file_motif_key <- '/data/miraldiNB/wayman/databank/motifs/Miraldi2019_Mm/TF_Information_all_motifs_plus_key.txt'
# Motif directory (or FIMO MEME file)
dir_motif <- '/data/miraldiNB/wayman/databank/motifs/Miraldi2019_Mm/mouse_ERM_CISBP_V1.02_split_meme'
# Genomic feature bed file (e.g., gene body, TSS)
# 4-column: [chr, start, end, feature name]
file_features <- '/data/miraldiNB/wayman/databank/genes/mm10/Ensembl_v99/mm10_gene_body_Ensembl_v99_filtered.bed'
